...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="biaya_gantioli" id="biaya_gantioli" placeholder="Masukkan 0 jika tidak ada biaya ganti oli" class="form-control" value="<?php echo e(old('biaya_gantioli')); ?>">
                        <?php $__errorArgs = ['biaya_gantili'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="biaya_gantiban" id="biaya_gantiban" placeholder="Masukkan 0 jika tidak ada biaya ganti ban" class="form-control" value="<?php echo e(old('biaya_gantiban')); ?>">
                        <?php $__errorArgs = ['biaya_gantiban'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\src\tugas5\resources\views/customer/create.blade.php ENDPATH**/ ?>